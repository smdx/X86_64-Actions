...
cp -f ${GITHUB_WORKSPACE}/patches/rtp2httpd/Makefile package/new/rtp2httpd/
echo "CONFIG_PACKAGE_luci-app-rtp2httpd=y" >> ${GITHUB_WORKSPACE}/openwrt/.config
echo "CONFIG_PACKAGE_rtp2httpd=y" >> ${GITHUB_WORKSPACE}/openwrt/.config
